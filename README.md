...
| `token-lifecycle-guard` | [`software-development/token-lifecycle-guard/`](software-development/token-lifecycle-guard/) | Deterministic read-only lifecycle detection and postflight terminal safety for delegated and background work. |
